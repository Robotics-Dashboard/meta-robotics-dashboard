DESCRIPTION = "Robotics Dashboard Embedded Heartbeat"
FILESEXTRAPATHS:prepend := "${THISDIR}/conf:"

LICENSE = "Apache-2.0"
LIC_FILES_CHKSUM = "file://../LICENSE;md5=86d3f3a95c324c9479bd8986968f4327"

SRC_URI = "git://github.com/Robotics-Dashboard/embedded.git;protocol=https;branch=main"
SRC_URI += "file://robotics-dashboard-heartbeat.service"
...
SYSTEMD_PACKAGES += "${PN}"
SYSTEMD_SERVICE:${PN} = "robotics-dashboard-heartbeat.service"
SYSTEMD_AUTO_ENABLE:${PN} = "enable"

do_install:append() {
    install -d ${D}${sysconfdir}/robotics-dashboard-heartbeat
    install -d ${D}${systemd_unitdir}/system
    install -m 0644 ${WORKDIR}/robotics-dashboard-heartbeat.service ${D}${systemd_unitdir}/system/
}